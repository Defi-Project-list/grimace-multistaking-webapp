        ...
        return (
            <div className='w-full xl:basis-1/2 flex flex-col md:flex-row justify-between xl:justify-around gap-4'>
                <div className='flex flex-col gap-1'>
                    ...
                    <div className='text-app-primary text-[20px] md:text-[22px] font-bold leading-[1.1]'>91,483,721,353.311 USDT</div>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <div className='text-app-primary text-[20px] md:text-[22px] font-bold leading-[1.1]'>123 Days Left</div>
        ...
        return (
            <div className='w-full sm:w-auto p-4 rounded-md border border-[#987DF9] bg-app-common xl:h-full'>
                {/* <div className='flex flex-col gap-4 justify-between h-full'>
                                            <div className='text-app-primary text-[12px] font-light'>Stake TKN</div>
                                            <Button
                                                variant="contained"
                ...
                <div className='flex flex-col gap-2 justify-between h-full'>
                    ...
                    <Button
                        variant="contained"
                        sx={{ width: '100%', height: '38px', minWidth: '200px', fontFamily: 'Inter' }}
                        color="secondary"
                        onClick={() => onStake()}
                    >
                ...
                {/* <div className='flex gap-4 items-center'>
                        <div className='flex flex-col gap-1'>
                            <div className='text-app-primary text-[12px] font-light'>TKN Staked</div>
                            <div className='text-app-primary text-[20px] md:text-[22px] font-bold leading-[1.1]'>6,002.35623 TKN</div>
                        ...
                        <div className='w-full xl:basis-1/2 flex flex-col sm:flex-row justify-between sm:justify-around gap-4'>
                            ...
                            <div className='w-full md:basis-1/2 flex justify-start sm:justify-end xl:justify-around gap-6 sm:gap-8 lg:gap-10'>
                                <div className='flex flex-col bg-app-box rounded-md px-2 py-1 h-[51px] shadow-sm shadow-[#000]'>
                                    ...
                                    <div className='text-app-primary text-[20px] md:text-[22px] font-bold leading-[1.1] whitespace-nowrap'>10.20%</div>
                                </div>
                        ...
                        <div className='w-full xl:w-auto flex items-stretch xl:gap-10'>
                            <div className='w-full xl:w-auto flex flex-col sm:flex-row p-4 sm:justify-between rounded-md border border-[#987DF9] gap-4 bg-app-common sm:items-center'>
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <div className='text-app-primary text-[20px] md:text-[22px] font-bold leading-[1.1] whitespace-nowrap'>721,353.31 USDT</div>
                                    <span className='text-app-primary text-[12px] font-light whitespace-nowrap'>1234 USD</span>
                                </div>
                                <div className='flex flex-col gap-1'>
                                    <div className='text-app-primary text-[12px] font-light'>Claimable Reward</div>
                                    <div className='text-app-primary text-[20px] md:text-[22px] font-bold leading-[1.1] whitespace-nowrap'>6,002.35623 TKN</div>
                                    <span className='text-app-primary text-[12px] font-light whitespace-nowrap'>123456 USD</span>
                                </div>
